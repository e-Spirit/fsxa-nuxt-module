...
| fsTppApiUrl             | undefined               | If you need to set or override the used URL to a specific `snap.js`.                                                                                                                                                                                                             |
| fsTppVersion            | undefined               | _DEPRECATED: use `fsTppApiUrl` instead_ You can provide a version for tpp-snap. Check [this](https://www.npmjs.com/package/fs-tpp-api) out for more details.                                                                                                                     |
